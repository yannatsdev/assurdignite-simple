              ...
              {step === 0 && (
                <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div><Label>Date de naissance de l'assuré principal *</Label><DateInput value={simPrincipalDob} onChange={e => setSimPrincipalDob(e.target.value)} /></div>
                    <div>
                      <Label>Formule</Label>
                  ...
                  {hasConjoint && (
                    <div className="pl-4"><Label className="text-xs">Date de naissance conjoint</Label><DateInput value={conjoint.dob} onChange={e => setConjoint({...conjoint, dob: e.target.value})} /></div>
                  )}
                  ...
                  {enfants.map((e, i) => (
                    <div key={i} className="flex gap-2 items-center pl-4">
                      <DateInput value={e.dob} onChange={ev => { const n = [...enfants]; n[i].dob = ev.target.value; setEnfants(n); }} className="flex-1" />
                  ...
                  {ascendants.map((a, i) => (
                    <div key={i} className="flex gap-2 items-center pl-4">
                      <DateInput value={a.dob} onChange={ev => { const n = [...ascendants]; n[i].dob = ev.target.value; setAscendants(n); }} className="flex-1" />
              ...
              {step === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div><Label>Date de naissance *</Label><DateInput value={kyc.dob || simPrincipalDob} onChange={e => setKyc({ ...kyc, dob: e.target.value })} /></div>
                  ...
                  {hasConjoint && (
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl bg-accent/50">
                        ...
                        <div><Label>Date de naissance</Label><DateInput value={conjoint.dob} onChange={e => setConjoint({ ...conjoint, dob: e.target.value })} /></div>
                      </div>
                      {/* Conjoint CNI */}
                      <div className="space-y-2">
                  ...
                  {enfants.map((e, i) => (
                    <div key={i} className="p-3 rounded-lg bg-accent/30 space-y-2">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        ...
                        <DateInput value={e.dob} onChange={ev => { const n = [...enfants]; n[i].dob = ev.target.value; setEnfants(n); }} />
                  ...
                  {ascendants.map((a, i) => (
                    <div key={i} className="p-3 rounded-lg bg-accent/30 space-y-2">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                        ...
                        <DateInput value={a.dob} onChange={ev => { const n = [...ascendants]; n[i].dob = ev.target.value; setAscendants(n); }} />
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          <div><Label>Date souhaitée de prise d'effet</Label><DateInput value={groupeData.dateEffet} onChange={e => setGroupeData({...groupeData, dateEffet: e.target.value})} /></div>
                          <div>
                        ...
                        {groupeMembers.map((m, i) => (
                          <div key={i} className="p-3 rounded-lg bg-accent/30 space-y-2">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                              ...
                              <DateInput value={m.dob} onChange={e => { const n = [...groupeMembers]; n[i].dob = e.target.value; setGroupeMembers(n); }} />
