        ...
        <CardContent className="pt-6 space-y-4">
          ...
          {currentStep === 3 && (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8 space-y-5">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">Votre dossier est en cours de traitement. Délai contractuel maximal : 15 jours ouvrés (Code CIMA). Notre objectif interne est un versement en quelques heures une fois le dossier vérifié.</p>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 max-w-sm mx-auto text-left">
                <p className="text-xs font-semibold text-primary mb-1">⏱ Délais</p>
                <p className="text-sm">Contractuel max : <strong>15 jours ouvrés</strong> (Code CIMA). Objectif interne non contractuel : quelques heures après validation.</p>
              </div>
