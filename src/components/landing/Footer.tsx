        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src={logoSonam} alt="SONAM VIE" className="h-10 brightness-0 invert" />
              <img src={logoAssurDignite} alt="AssurDignité" className="h-8 brightness-0 invert" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-center gap-2"><Phone className="w-4 h-4" /> 27 20 31 71 82</li>
              <li className="flex items-center gap-2"><Phone className="w-4 h-4" /> 05 95 45 21 65</li>
              <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> servicecommercialsonamvie@sonam.ci</li>
            </ul>
          </div>
        </div>
