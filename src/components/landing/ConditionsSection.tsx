...
const sections = [
  ...
  { title: "Article 2 – Conditions d'adhésion", content: "L'adhésion est ouverte à toute personne physique résidant en Côte d'Ivoire ou dans la zone CIMA, âgée de 18 à 64 ans (assuré principal), de 0 à 21 ans (enfants) et de 0 à 79 ans (ascendants). L'adhésion est subordonnée au paiement intégral de la première prime annuelle." },
