...
const sections = [
  ...
  { title: "Article 2 – Conditions d'adhésion", content: "L'adhésion est ouverte à toute personne physique résidant en Côte d'Ivoire ou dans la zone CIMA. Assuré Principal & conjoint : 18 à 64 ans à la souscription (âge + durée du contrat ≤ 65 ans). Enfants : 0 à 21 ans. Ascendants : jusqu'à 89 ans à la souscription, couverture maximale 90 ans (limite nettement plus large que le marché, généralement 55 à 75 ans). Un questionnaire médical peut être requis selon l'âge et le profil. L'adhésion est subordonnée au paiement effectif de la première prime et à la validation du KYC." },
  { title: "Article 3 – Prestations garanties", content: "En cas de décès de l'assuré, SONAM VIE s'engage à fournir : cercueil extérieur, conservation du corps, transport funéraire, cérémonie d'inhumation (70% du capital en nature), et le versement de 30% du capital en espèces au(x) bénéficiaire(s) désigné(s). Délai contractuel maximal de règlement : 15 jours ouvrés après réception du dossier complet (conformément au Code CIMA). Notre objectif interne — non contractuel — est un versement en quelques heures une fois le dossier vérifié. En cas d'impossibilité de prestation en nature (décès survenu à l'étranger, inhumation déjà réalisée selon certains rites), l'intégralité (100%) du capital garanti est versée en espèces." },
  ...
  { title: "Article 5 – Obligations de l'adhérent", content: "L'adhérent s'engage à : payer la prime à la date d'échéance selon la périodicité choisie, déclarer tout changement de situation familiale, fournir des informations exactes lors de l'adhésion et de la déclaration de sinistre. Toute fausse déclaration peut entraîner la nullité du contrat." },
  { title: "Article 6 – Bonus Fidélité-Santé", content: "Si aucun sinistre n'est déclaré dans le groupe familial assuré pendant 3 années consécutives, l'adhérent bénéficie d'une ristourne de 30% de la prime annuelle de l'Assuré Principal (et non de la prime familiale totale). Elle est versée sur le compte Mobile Money du souscripteur." },
